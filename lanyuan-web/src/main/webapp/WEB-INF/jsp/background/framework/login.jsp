...
<title>蓝缘管理系统</title>
<link href="/lanyuan-web/css/main.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script type="text/javascript" src="/lanyuan-web/js/jquery-1.8.3.js"></script>
<script type="text/javascript" src="/lanyuan-web/js/fun.base.js"></script>
<script type="text/javascript" src="/lanyuan-web/js/script.js"></script>
...
function checkUserForm() {
	...
	$.ajax({
				type : "POST",
				url : "/lanyuan-web/loginCheck.html?data="
						+ new Date(),
				data : {
					username : userName,
